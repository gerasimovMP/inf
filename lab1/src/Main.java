...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        main.readText("res/Full.txt", charactersLab.originalFullText);
        main.readText("res/Chapter.txt", charactersLab.originalChapterText);
    ...
    private void checkText(StringBuilder originalChapterText, StringBuilder decryptedText){
        ...
        percent = ((float)numOfGoodChars / (float) textLength) ;
